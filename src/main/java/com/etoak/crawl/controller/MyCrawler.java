...
public class MyCrawler {
    ...
    public void crawling(String[] seeds) {
        ...
        LinkFilter filter = new LinkFilter() {
            ...
            public boolean accept(String url) {
                if (url.startsWith("https://upassport.ke.com/freshCaptch?t=\"+System.currentTimeMillis()")){
                    return true;}
                else{
                    return false;}
            }
    ...
    public static void main(String[] args) {
        ...
        crawler.crawling(new String[]{"https://upassport.ke.com/freshCaptch?t=\"+System.currentTimeMillis()"});
    }
}